...
import (
	...
	"github.com/hasemeneh/poc-login/internal/handler/rest/private"
	"github.com/hasemeneh/poc-login/internal/handler/rest/public"
	"github.com/hasemeneh/poc-login/internal/service"
	"github.com/hasemeneh/poc-login/pkg/router"
	routeradapter "github.com/hasemeneh/poc-login/pkg/router/adapter"
	"github.com/hasemeneh/poc-login/pkg/webservice"
)
